    ...
    <div className='flex justify-between text-dark items-center'>
      <div className='max-w-[630px]'>
        ...
        <div className='flex gap-4'>
          <a href="https://www.apple.com/pl/app-store/" target='_blank' className='flex pl-5 w-[200px] h-[64px] font-semibold space-x-2 border border-dark rounded-full items-center hover:bg-dark hover:text-background'>
          ...
          <a href="https://play.google.com/store/games?hl=ru" target='_blank' className='flex pl-5 w-[200px] h-[64px] font-semibold space-x-2 border border-dark rounded-full items-center hover:bg-dark hover:text-background'>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
