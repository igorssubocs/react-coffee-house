...
export default function MobileApp() {
  return (
    <div className='flex justify-between text-dark items-center'>
      <div className='max-w-[630px]'>
        ...
        <ul className='flex gap-4 font-semibold'>
          <li className=''>
            <a href="https://www.apple.com/pl/app-store/" target='_blank' className='flex pl-5 w-[200px] h-[64px] space-x-2 border border-dark rounded-full items-center hover:bg-dark hover:text-background hover:transition delay-150 duration-300 ease-in'>
          ...
          <li>
            <a href="https://play.google.com/store/games?hl=ru" target='_blank' className='flex pl-5 w-[200px] h-[64px] space-x-2 border border-dark rounded-full items-center hover:bg-dark hover:text-background hover:transition delay-150 duration-300 ease-in'>
              <svg width="36" height="36" viewBox="0 0 36 36" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
